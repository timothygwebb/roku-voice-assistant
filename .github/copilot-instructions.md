...
- **Testing & CI**: CI workflow in `.github/workflows/voice-ci.yml` installs dependencies and `ffmpeg` to validate the environment. CodeQL security scanning via GitHub default setup.
